...
public class NoticeDBBean {
	...
	public int insertBoard(NoticeBean board) throws Exception {	//값을 추가하는 메소드
		...
		try {
			conn = getConnection();
			sql="select max(n_num) from notice";	//공지사항 번호 출력
	...
	public ArrayList<NoticeBean> listBoard(String pageNumber){	//리스트에 추가하는 메소드
		Connection conn=null;
		Statement stmt=null;
		ResultSet rs=null;
	...
	public NoticeBean getBoard(int num, boolean hitadd) {	//글번호 -> 작성자 글내용 확인하는 메소드
		Connection conn=null;
	...
	public int deleteBoard(int n_num, String n_pwd) {	//n_num와 pwd를 받아 삭제하는 메소드
		Connection conn=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		String sql="";
	...
	public int editBoard(NoticeBean board) {	//board를 받아서 수정하는 메소드
		Connection conn=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		String sql="";
