...
%>
 ...
 <%
			int j = 0;
         	...
         	ArrayList<ProductBean> productListArr = productdb.getProductlist();
         	ArrayList<ProductBean> ProductImgListArr  =  productdb.getProductimg(productListArr);
         	int size = 0;
			...
			<tr>
				...
				<%
					...
					%> 		 
		    		 <table border="">	    		 
						<tr>	 
							<td colspan="2">  <a href="./../cart/goodsDisplay.jsp?product_number=<%=orgin_file_name%>"><img src="./../images/products/<%=stored_file_name%>.jpg" style="width: 300px; height: 300px;"></a></td></tr>	   
				    	<tr>
