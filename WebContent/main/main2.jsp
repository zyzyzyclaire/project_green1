...
%>	
            ...
            <div class="d-flex justify-content-between headertop">
                <nav class="nav navbox" style="margin-left: 100px">
	                <%
	                	if(user_id==null){
	                %>
                ...
                <ul class="nav justify-content-end ulbox" style="margin-right: 100px">
			...
			%>	
								   	 ...
								   	 <li class="nav-item">   	  
							    		   <div class="card" style="width: 18rem;">
											   <a href="./../cart/goodsDisplay.jsp?product_number=<%=product_number%>"><img src="<%= request.getContextPath() %><%= File.separator %>upload<%= File.separator %><%=stored_file_namearr[0]%>" style="width: 300px; height: 300px;" alt="이미지없음"></a>
